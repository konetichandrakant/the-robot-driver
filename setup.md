...
#====================================================
#  The Robot Driver - Docker Setup Guide
#  (Windows WSL2 Example)
#====================================================
# Run these commands in your WSL terminal after installing:
#   - WSL / WSL2
#   - Docker Desktop (with WSL integration enabled)
#   - An X server on Windows (e.g. VcXsrv / Xming)
#====================================================

#----------------------------------------
#  1. Display Environment Configuration
#----------------------------------------
# Configure X11 display forwarding for GUI apps in Docker
# so Playwright can show a real browser (when not headless).
...
cd /mnt/d/ck/projects/the-robot-driver
...
# Create it if it doesn't exist (edit with nano/vim).
#
# Example minimal contents (DO NOT commit real secrets):
#
...
#
#   - service: automation_test
#       -> runs tests/test_automation_api.py
#
#   - service: login_task_test
#       -> runs tests/test_login_task.py (with GUI/X11 support)
#
...
# (use with care, this cleans up globally)
...
#
# - GUI doesn't show up for login_task_test:
...
#     -> docker-compose mounts ./src and ./tests, so usually no rebuild needed
